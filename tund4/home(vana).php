<?php
  ...
  $imghtml .= '<img src="../vp_pics/' .$allpics[mt_rand(0, ($piccount - 1))] .'" ';
  $imghtml .= 'alt ="Tallinna Ülikool">';
...
<img src="../pildid/vp_banner.png" alt="Veebiproge kursuse bänner" >
  ...
  <ul>
	...
	<li><a href="lisamõte.php">Mõtete lisamine</a></li>
	<li><a href="mõtted.php">Mõtete lugemine</a></li>
	<li><a href="listfilms.php">Filmiinfo</a></li>
