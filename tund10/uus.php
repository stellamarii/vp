<?php
	...
	$lastvisitor = null;
	//cookies
	//setcookie - enne html algust
	setcookie("vpvisitorname", $_SESSION["kasutajaenimi"] . " " .$_SESSION["kasutajapnimi"], time()+(86400*8), "/~steltam/", "greeny.cs.tlu.ee", isset($_SERVER["HTTPS"]), true);
	//kas on cookie olemas?
...
?>
	...
	<ul>
		...
		<li><a href="photogallery_public.php">Pildigalerii</a></li>
		<hr>
